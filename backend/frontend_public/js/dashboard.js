...
document.addEventListener('DOMContentLoaded', () => {
   ...
   async function loadDashboardStats() {
    try {
        const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/stats');
    ...
    try {
        const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/attendance');
        const stats = await res.json();
...
if (feeBalanceEl) feeBalanceEl.innerText = `Balance: Ksh ${stats.fees.balance.toLocaleString()}`;
    ...
    async function fetchUsers() {
        try {
            const res = await fetch('https://destinydeterminersacademy.onrender.com/api/auth/signup', {
                method: 'GET',
                headers: {
...
//fees
   async function loadFeesStats() {
    ...
    async function fetchAccounts() {
        try {
            const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/accounts');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (clubForm && clubNameInput && advisorInput) {
            clubForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/clubs', {
                        method: 'POST',
    ...
    async function fetchBooks() {
        try {
            const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/books');
    ...
    if (eventForm) {
        eventForm.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/events', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    document.getElementById('add-teacher-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/users/teachers', {
                method: 'POST',
    ...
    document.getElementById('add-student-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/users/students', {
                method: 'POST',
    ...
    document.getElementById('broadcast-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://destinydeterminersacademy.onrender.com/api/broadcast', {
                method: 'POST',
    ...
    document.getElementById('backup-btn')?.addEventListener('click', () => {
        window.location.href = 'https://destinydeterminersacademy.onrender.com/api/backup/download';
    });
