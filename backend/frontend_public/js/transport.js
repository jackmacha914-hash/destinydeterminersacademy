...
async function loadBusesDropdown(selectId) {
    ...
    try {
        const res = await fetch('https://destinydeterminersacademy.onrender.com/api/transport/buses');
...
async function loadRoutesDropdown(selectId) {
    ...
    try {
        const res = await fetch('https://destinydeterminersacademy.onrender.com/api/transport/routes');
...
async function loadStudentsDropdown(selectId) {
    ...
    try {
        const res = await fetch('https://destinydeterminersacademy.onrender.com/api/students'); // adjust route if needed
...
document.addEventListener('DOMContentLoaded', () => {
    const API_BASE = "https://destinydeterminersacademy.onrender.com/api/transport";
 ...
 async function loadAttendanceStudents(routeId) {
    ...
    try {
        ...
        const res = await fetch(
            `https://destinydeterminersacademy.onrender.com/api/transport/assignments?routeId=${routeId}`
        );
        const assignments = await res.json();
...
//---------------------------------
    ...
    try {
        await fetch('https://destinydeterminersacademy.onrender.com/api/transport/attendance', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    try {
        await fetch(
            'https://destinydeterminersacademy.onrender.com/api/transport/attendance',
            {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
