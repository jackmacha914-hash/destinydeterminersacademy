...
async function loadFeesWithFilters() {
    ...
    let url = 'https://judahcareacademy.onrender.com/api/fees';
    ...
    feesBulkDelete.onclick = async function() {
        ...
        universalConfirmYes.onclick = async () => {
            ...
            for (const feeId of selectedFeeIds) {
                try {
                    await fetch(`https://judahcareacademy.onrender.com/api/fees/${feeId}`, {
                        method: 'DELETE',
...
async function handleClassChange(event) {
    ...
    try {
        ...
        const endpoints = [
            `https://judahcareacademy.onrender.com/api/students/class/${classId}`,
            `https://judahcareacademy.onrender.com/api/class/${classId}/students`,
            `https://judahcareacademy.onrender.com/api/class/students?classId=${classId}`,
            'https://judahcareacademy.onrender.com/api/students'
        ];
        ...
        if (endpoints.includes('https://judahcareacademy.onrender.com/api/students')) {
...
if (feeForm) {
    feeForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const res = await fetch('https://judahcareacademy.onrender.com/api/fees', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
  ...
  feeList.addEventListener('click', async (e) => {
    ...
    if (btn.classList.contains('edit-fee-btn')) {
        ...
        universalEditForm.onsubmit = async (ev) => {
            ...
            try {
                const res = await fetch(`https://judahcareacademy.onrender.com/api/fees/${feeId}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
