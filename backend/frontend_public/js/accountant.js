...
async function loadFeesWithFilters() {
    ...
    let url = 'https://destinydeterminersacademy.onrender.com/api/fees';
    ...
    feesBulkDelete.onclick = async function() {
        ...
        universalConfirmYes.onclick = async () => {
            ...
            for (const feeId of selectedFeeIds) {
                try {
                    await fetch(`https://destinydeterminersacademy.onrender.com/api/fees/${feeId}`, {
                        method: 'DELETE',
...
async function handleClassChange(event) {
    ...
    try {
        ...
        const endpoints = [
            `https://destinydeterminersacademy.onrender.com/api/students/class/${classId}`,
            `https://destinydeterminersacademy.onrender.com/api/class/${classId}/students`,
            `https://destinydeterminersacademy.onrender.com/api/class/students?classId=${classId}`,
            'https://destinydeterminersacademy.onrender.com/api/students'
        ];
        ...
        if (endpoints.includes('https://destinydeterminersacademy.onrender.com/api/students')) {
  ...
  feeList.addEventListener('click', async (e) => {
    ...
    if (btn.classList.contains('edit-fee-btn')) {
        ...
        universalEditForm.onsubmit = async (ev) => {
            ...
            try {
                const res = await fetch(`https://destinydeterminersacademy.onrender.com/api/fees/${feeId}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
