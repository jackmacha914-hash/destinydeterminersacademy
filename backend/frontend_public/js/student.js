...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (profileForm) {
        profileForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://judahcareacademy.onrender.com/api/students/profile', {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
    ...
    async function fetchResources() {
      ...
      try {
        const response = await fetch("https://judahcareacademy.onrender.com/api/resources", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`
          }
        ...
        data.resources.forEach(resource => {
          ...
          link.href = `${window.API_CONFIG?.UPLOADS_PATH || 'https://judahcareacademy.onrender.com/uploads'}/resources//uploads/resources/${resource.path}`;
    ...
    async function fetchFeeRecords() {
        try {
            ...
            const response = await fetch(`https://judahcareacademy.onrender.com/api/fees?populate=payments`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
            ...
            return `
                <div class="homework-card ${isPastDue ? 'past-due' : ''} ${isSubmitted ? 'submitted' : ''}">
                    ...
                    <div class="homework-details">
                        ...
                        ${homework.file ? `
                            <div class="homework-file">
                                ...
                                <a href="${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${homework.file}" target="_blank" class="file-link">
                    ...
                    <div class="homework-actions">
                        ...
                        ${homework.file ? `
                            <a href="${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${homework.file}" class="btn btn-outline-primary" target="_blank">
    ...
    async function handleHomeworkSubmission(e) {
        ...
        try {
            ...
            const response = await fetch(`https://judahcareacademy.onrender.com/api/homeworks/submit/${homeworkId}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`
