document.addEventListener('DOMContentLoaded', () => {
    ...
    if (createHomeworkForm) {
        createHomeworkForm.onsubmit = async (e) => {
            ...
            try {
                ...
                // Prepare the request
                const response = await fetch('https://judahcareacademy.onrender.com/api/homeworks', {
                    method: 'POST',
                    headers: {
    ...
    if (createAssignmentForm) {
        createAssignmentForm.onsubmit = async (e) => {
            ...
            try {
                ...
                // Prepare the request
                const response = await fetch('https://judahcareacademy.onrender.com/api/assignments', {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`
                    },
  ...
  function renderHomeworks(classFilter = 'all') {
    ...
    filteredHomeworks.forEach(homework => {
      ...
      li.innerHTML = `
        ...
        ${homework.file ? `<p><strong>File:</strong> <a href="${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${homework.file}" target="_blank">Download</a></p>` : ''}
  ...
  async function viewHomeworkSubmissions(homeworkId) {
    try {
      ...
      try {
        const response = await fetch(`https://judahcareacademy.onrender.com/api/homeworks/${homeworkId}`, {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  async function gradeHomework(homeworkId, submissionId) {
    try {
      ...
      const response = await fetch(`https://judahcareacademy.onrender.com/api/homeworks/grade/${homeworkId}/${submissionId}`, {
        method: 'PUT',
        headers: {
  ...
  class ClassManagement {
    ...
    async handleClassFormSubmit(e) {
      ...
      try {
        ...
        if (isEditMode && classId) {
          ...
          response = await fetch(`https://judahcareacademy.onrender.com/api/classes/${classId}`, {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
          ...
          // Create new class
          response = await fetch('https://judahcareacademy.onrender.com/api/classes', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
    ...
    async fetchClasses() {
      try {
        ...
        const response = await fetch('https://judahcareacademy.onrender.com/api/classes', {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
        ...
        btn.addEventListener('click', async (e) => {
          ...
          if (confirm(`Are you sure you want to delete the class "${classToDelete.name}"? This action cannot be undone.`)) {
            try {
              ...
              const response = await fetch(`https://judahcareacademy.onrender.com/api/classes/${classId}`, {
                method: 'DELETE',
                headers: {
                  'Authorization': `Bearer ${token}`
                }
  ...
  try {
    ...
    initGradeManagement() {
      ...
      if (gradesTable) {
        ...
        const token = localStorage.getItem('token');
        const API_BASE_URL = 'https://judahcareacademy.onrender.com';
...
postAnnouncement(text) {
  ...
  fetch('https://judahcareacademy.onrender.com/api/announcements', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
  ...
  .catch(err => {
    ...
    async saveAnnouncement(text) {
      try {
        ...
        const response = await fetch('https://judahcareacademy.onrender.com/api/announcements', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
    ...
    async deleteAnnouncement(announcementId, announcementItem) {
      try {
        ...
        const response = await fetch(`https://judahcareacademy.onrender.com/api/announcements/${announcementId}`, {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`
          }
    ...
    initReportCardUpload() {
      ...
      uploadForm.addEventListener('submit', async (e) => {
        ...
        try {
          const token = localStorage.getItem('token');
          const response = await fetch('https://judahcareacademy.onrender.com/api/report-cards', {
            method: 'POST',
    ...
    async fetchReportCards() {
      try {
        ...
        const studentsResponse = await fetch('https://judahcareacademy.onrender.com/api/students', {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
          },
        ...
        for (const student of students) {
          for (const term of terms) {
            try {
              const marksResponse = await fetch(`${window.API_CONFIG?.API_BASE_URL || 'https://judahcareacademy.onrender.com'}/marks/student/${student._id}?term=${encodeURIComponent(term)}`, {
                headers: {
                  'Authorization': `Bearer ${token}`,
                  'Content-Type': 'application/json'
                },
    ...
    async loadStudentsForReportCardDropdown() {
      try {
        const token = localStorage.getItem('token');
        const response = await fetch('https://judahcareacademy.onrender.com/api/students', {
          headers: token ? { 'Authorization': 'Bearer ' + token } : {}
        });
...
const API_BASE_URL = 'https://judahcareacademy.onrender.com';
  ...
  async function handleAddGrade(e) {
    ...
    try {
      ...
      const response = await fetch('https://judahcareacademy.onrender.com/api/grades', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  async function handleSaveMarks(e) {
    ...
    try {
      ...
      try {
        ...
        const response = await fetch('https://judahcareacademy.onrender.com/api/report-cards/generate', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
      ...
      viewPdfBtn.onclick = () => window.open(`${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${result.data.path}`, '_blank');
      ...
      downloadBtn.onclick = () => {
        const link = document.createElement('a');
        link.href = `${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${result.data.path}`;
  ...
  async function downloadAsPDF() {
    ...
    try {
      ...
      setTimeout(() => {
        const pdfUrl = `${window.API_CONFIG?.BASE_URL || 'https://judahcareacademy.onrender.com'}${result.data.path}`;
