...
class AccountantFees {
    ...
    initialize() {
        ...
        this.tryDeleteFee = async (feeId, token) => {
            ...
            try {
                const deleteUrl = `https://judahcareacademy.onrender.com/api/fees/${feeId}`;
    ...
    async loadFeesWithFilters() {
        ...
        try {
           ...
           if (yearFilter) params.append('academicYear', yearFilter);
            ...
            const apiUrl = `https://judahcareacademy.onrender.com/api/fees?${params.toString()}`;
...
async recordPayment(feeId) {
    try {
        ...
        const response = await fetch(`https://judahcareacademy.onrender.com/api/fees/${feeId}/payments`, {
            method: 'POST',
...
printReceipt(data) {
    ...
    async getFeeById(feeId) {
        try {
            ...
            const response = await fetch(`https://judahcareacademy.onrender.com/api/fees/${feeId}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
